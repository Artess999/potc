...
void WhrCreateSeaEnvironment()
{
	...
	Sea.Sea2.WaterColor = Whr_GetColor(aSea, "Water.Color");
    Sea.Sea2.SkyColor = Whr_GetColor(aSea, "Sky.Color");

    Sea.Sea2.Reflection = Whr_GetFloat(aSea, "WaterReflection");
    Sea.Sea2.Transparency = Whr_GetFloat(aSea, "Transparency");
    Sea.Sea2.Attenuation = Whr_GetFloat(aSea, "WaterAttenuation");
    Sea.Sea2.Frenel = Whr_GetFloat(aSea, "FrenelCoefficient");
