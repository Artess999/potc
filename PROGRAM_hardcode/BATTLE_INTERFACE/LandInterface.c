...
void BLI_SetObjectData()
{
	...
	objLandInterface.CommandTextures.list.t1.xsize = 8;
	...
	objLandInterface.CommandTextures.list.t5.xsize = 2;
	...
	objLandInterface.CommandTextures.list.t6.xsize = 2;
    ...
    int leftPosCom = sti(showWindow.left)+RecalculateHIcon(16);
	int topPosCom = sti(showWindow.bottom)-RecalculateVIcon(80);
	objLandInterface.ManSign.iconoffset1 = leftPosCom + "," + topPosCom;
