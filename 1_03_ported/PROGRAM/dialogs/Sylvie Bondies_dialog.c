...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// включить проверку, если девушка была или захвачена игроком, но выкуп за нее —ильвией уже заплачен, то она ругает игрока.
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "goddaughter_denied_confirm":
			...
			///////////////////////////////////////////
			// ”брать сабину и перегрузить локацию
			///////////////////////////////////////////
		...
		case "goddaughter_1":
			...
			link.l1.go = "exit";
			////////////////////////////////////////
			// ”брать письмо, добавить новое письмо
			////////////////////////////////////////
			ChangeCharacterReputation(pchar, 1);
			characters[GetCharacterIndex("Sabine Matton")].quest.hire = "almost_done";
