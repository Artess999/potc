...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_10_1":
			...
			Link.l1.go = "Exit";
		break;
//--------------------------ƒиалог 2: »грок познакомилс€ с –исом, но отказалс€ ему помочь.
...
//-------------------------ƒиалог 3 - »грок поговорил с Ѕлюмом, и согласилс€ ему помочь.
...
//-------------------------------ƒиалог 4 - если игроку не удалось уломать начальника порта.
...
//-------------------------------ƒиалог 4 - игроку удалось уговорить начальника порта .
