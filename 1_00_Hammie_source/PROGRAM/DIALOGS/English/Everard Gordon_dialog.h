...
"A fine idea. But I don't know how you'd manage it. You couldn't get to it from the sea - not with the port so heavily defended. And to approach it from land would be suicide. Unless... Yes! Most of the ship's crew is in town at the moment - they were given shore leave. Only a skeleton crew is onboard now",
